...
export default function Portfolio() {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <motion.section
        className="flex flex-col items-center justify-center text-center h-[calc(100vh-4rem)] px-4"
        initial="hidden"
        animate="visible"
        variants={{
          hidden: { opacity: 0 },
      ...
      {/* Seções Restantes com Estrutura Similar */}
      <section
        id="about"
